<?php
	...
	else if($_POST['service'] == 'register')
	{
		...
		if($info['lang'] == 'fr') {
			...
			$iplang['The Irresistible Package'] = 'Forfait Irrésistible';
			$iplang['Congratulations.'] = 'Félicitations.';
			$iplang['Thank you for claiming your Irresistible Package.'] = 'Merci d’avoir réclamé votre Forfait Irrésistible.';
			$iplang['Thank you for registering for your Irresistible Package.'] = "Merci de votre inscription pour votre Forfait Irrésistible.";
			...
			include_once('en.php');
			$iplang['irresistible_email_logo'] = 'irresistible_email_logo';
			$iplang['The Irresistible Package'] = 'The Canadian Black Book Private Sale Event';
			$iplang['Congratulations.'] = 'Congratulations.';
			$iplang['Thank you for claiming your Irresistible Package.'] = 'Thank you for claiming your Personal Offers.';
			$iplang['Thank you for registering for your Irresistible Package.'] = "Thank you for registering for your Personal Offers.";
			$iplang['You have successfully claimed the following offers'] = 'You have successfully claimed the following offers';
			$iplang['Please redeem these special offers at the dealership'] = 'Please redeem these special offers at the dealership';
		}
		...
		try
		{
			...
			$message = Swift_Message::newInstance($lang['The Irresistible Package']);
			...
			$body .= '<img src="' .$message->embed(Swift_Image::fromPath('../../rsvp/blackbook/images/email/EmailHeader.png')) . '" /><br><br><br>';
			$body .= '<font style="font-size:14pt;font-weight:bold">' . $lang['Congratulations.'] . '</font><br>';

			if(!isset($_POST['secondEmail'])){
				$body .= '' . $lang['Thank you for registering for your Irresistible Package.'] . '<br><br>';
				if(isset($offers['cbb']))
				{
			...
			//SEND THE SELECTED OFFERS
				...
				$body .= '' . $lang['Thank you for claiming your Irresistible Package.'] . '<br><br>';
