<?php
	...
	<head>
		...
		<title>Absolute Results Trainer Conference 2018</title>
	...
	if(isset($_POST['submitForm'])){
		...
		$tc = TrainerConference2018::where('firstname', $clean['firstname'])->where('lastname', $clean['lastname'])->getOne();

		if(!$tc instanceof TrainerConference2018){
			$tc = new TrainerConference2018();
		}
		...
		if(!$tc->save()){
			...
			header('location:http://10.21.0.238/rsvp2018');
			exit;
		}
	}
	//print_r2($data);
	...
	$superbowlrsvps = TrainerConference2018::where('superbowl',1)->get();
		...
		<div class="row">
					...
					<div style="margin-bottom: 20px">
						...
						<div style="display:inline-block; width: 83%">
							...
							<div style="padding-left: 10px; font-size: 0.9em;">
								We are excited to announce the first annual Absolute Results Trainers Conference happening February 5 – 7, 2018.
							</div>
						</div>
			...
			<div class="col-md-8 col-md-pull-4" style="min-height: 580px;">
				<div class="small-size-margin add-extra-top-margin" style="padding: 15px; border-radius: 15px; background-color: rgba(0,0,0,0.75); color: white; ">
					<h2 style="margin-top: 10px;border-bottom: 2px solid white;  ">ABSOLUTE <span style="color: red">RESULTS</span> 2018 Trainer Conference</h2>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									&nbsp;&nbsp; Will you attend the optional Superbowl party on Sunday, February 4?
								</div>
					...
					<table class="table table-curved" style="overflow:hidden; font-weight:bold;">
						...
						<tbody>
							...
							<tr style="background-color: rgba(0,0,0,0.8); color: white; ">
								...
								<td>8:00 AM</td>
								<td>Conference Wrap Up at 12:00 PM</td>
							</tr>
						</tbody>
...
<!-- <div class="container2">
	...
	?>
		...
		<div class="row">
			<div class="col-xs-12">
				<p>We are excited to announce the first annual Absolute Results Trainers Conference happening February 6 – 8, 2018 at Semiahmoo Resort in Blaine, Washington.</p>
