	...
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				...
				<li class="active">
					<?= (is_null($transaction->id) ? 'Add' : 'Edit') ?> Show
				</li>
			</ol>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" datetimepicker name="arrivalTime" placeholder="y-m-d h:i" value="<?= (is_null($show->arrivalTime) ? '' : $show->arrivalTime->format('Y-m-d H:i:s')) ?>">
					</div>
				</div>
			</div>
		</div>
