...
<table cellspacing="0" cellpadding="0" class="insertDetailTbl">
	<tr>
		<td>Dealer:</td>
		<td style="font-weight:bold"><?= $_SESSION['loadContacts']['dealerName'] ?></td>
	</tr>
	<tr>
		<td>Excel:</td>
		<td style="font-weight:bold"><?= stripslashes($_SESSION['loadContacts']['excelPath']) ?></td>
	</tr>
</table>
<br><br>
<form name="loadContactsForm" enctype="multipart/form-data" method="POST">
...
<?php
	$i = 0;
	foreach($contentHeader as $columnContent)
	{
?>
	<tr>
		<td>
